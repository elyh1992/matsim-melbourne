...
public class network_allowed_mode {
   public static void main(String[] args) {
       Network network = NetworkUtils.createNetwork();
       NetworkFactory factory	= network.getFactory();
       new MatsimNetworkReader(network).readFile("C:/Users/ehajhashemi/Desktop/Files/MATSim codes/matsim-melbourne/scenarios/2017-11-scenario-by-kai-from-vista/cn_modified_new.xml");
 ...
 /*      List<String[]> rowList = new ArrayList<String[]>();
       ...
       for (Link l : network.getLinks().values() ) {
           ...
           if (allowed_mode.contains("bicycle") || allowed_mode.contains("walk") ) {
               final Id<Link> id = l.getId();
               /*System.out.println(id);*/
               /*network.removeLink(id);*/
               network.getLinks().get(id).setAllowedModes(CollectionUtils.stringToSet("car"));
      ...
      /* double counter = 0;
       ...
       new NetworkWriter(network).write("C:/Users/ehajhashemi/Desktop/Files/MATSim codes/matsim-melbourne/scenarios/2017-11-scenario-by-kai-from-vista/cn_modified_new.xml");
