 ...
 *
 */
final class CreateTenPercentPopulation<csvFormat> {
	private static final String pusPersonsFile = "data/population_ten_percent_reduced.csv" ;
	private static final String pusTripsFile = "data/trip_ten_percent_final.csv" ;

	private static final String zonesFile = "data/SA1_2011_AUST.shp";

	private static final Logger log = Logger.getLogger( CreateTenPercentPopulation.class ) ;
...
//			return CoordUtils.createCoord(271704., 5784843. ) ; // dummy coordinate; should be around Geelong.  kai, nov'17
	...
	CreateTenPercentPopulation() throws IOException {
	...
	private void createPUSPersons() {
		...
		try ( BufferedReader bufferedReader = new BufferedReader(new FileReader(pusPersonsFile)) ) {
			...
			/*int index_personId = 84;*/
			int index_age = 2;
			/*int index_age = 7;*/
			/*int index_sex = 82; //when male 1 when woman 0*/
			int index_sex = 7; //when male 1 when woman 0
			int CarAvailability_index= 8;
			/*int CarAvailability_index= 83;*/
			int totalvehs_index= 3;
			/*int totalvehs_index= 78;*/
			int num_cars_index= 4;
...
/*	public void matchFirstAndLastAct()
	...
	public static void main(String[] args) throws IOException {
		...
		CreateTenPercentPopulation createDemand = new CreateTenPercentPopulation();
		createDemand.run();
